<template>
  <section class="container-fluid elevation-5">
    <section class="resume card shadow rounded-1 w-100" style="">
      <div class="row d-flex">
        ...
        <div class="col-4 bg-left text-center" style="background-color: rgba(49, 95, 243, 0.949);">
          ...
          <div class="row">
            <div class="col-12">
              <img src="https://media.licdn.com/dms/image/D5603AQE1oMhSUgp7eQ/profile-displayphoto-shrink_800_800/0/1686836283314?e=1693440000&v=beta&t=sCT3w6gETah9CvOsjMMcaPnhffQ2gCvVUZsQfK96G_U" class="img-fluid myCoverImg elevation-5" style="" alt="logo" />
            </div>
          </div>
          ...
          <!-- <div class="row justify-content-center align-items-center my-2">
            <div class="col-10 card m-2" style="background-color: #39456b98;">
              ...
              <div class="row card-body">
                <div class="col-6 card-text card-left">
                  <p>Lorem Ipsum</p>
                  <p>Lorem Ipsum</p>
                  <p>Lorem Ipsum</p>
                </div>
                  ...
                  <article class="resume-section">
                      <h5 class="card-header header-right bg-accent">Game Pursuit { Team Capstone }</h5>
                        ...
                        <p class="card-text card-right">
                          ...
                          <br>
                          <a href="https://github.com/ChanthaKammer/capstone" target="_blank" class="ps-3" rel="noopener noreferrer">Github Link</a>
                        </p>
                      ...
                      <h5 class="card-header header-right bg-accent">Cohort Final</h5>
                        ...
                        <p class="card-text card-right">
                          ...
                          <br>
                          <a href="repo-link" target="_blank" class="ps-3" rel="noopener noreferrer">Github Link</a>
                        </p>
                      ...
                      <h5 class="card-header header-right bg-accent">Tower</h5>
                        ...
                        <p class="card-text card-right">
                          ...
                          <br>
                          <a href="https://github.com/AJVancattenburch/tower" target="_blank" class="ps-3" rel="noopener noreferrer">Github Link</a>
                        </p>
...
.header-right {
  ...
  background-color: #0a43fe2e;
  border-radius: .5rem;
  padding-left: 2rem;
}

.bg-accent {
  background-color: #0a43fe15;
  margin-top: 1rem;
  margin-bottom: 1rem;
  margin-left: 1rem;
  padding-right: 2rem;
...
.myCoverImg {
  ...
  margin-top: 5vh;
  margin-left: 1rem;
  clip-path: polygon(0% 0%, 60% 0%, 60% 0%, 100% 50%, 60% 100%, 60% 100%, 0% 100%);
}

.bg-profession-tag {
  color: black;
  text-shadow: 1px 1px 3px white;
  background-color: #0a43fefb;
  border-radius: .5rem;
  padding-left: 2rem;
  margin-top: 1rem;
  width: 75%;
  clip-path: polygon(3% 0%, 60% 0%, 60% 0%, 100% 0%, 97% 100%, 60% 100%, 0% 100%);
  box-shadow: 10px 0px 10px 10px inset #dcecfa;
}
